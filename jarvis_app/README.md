...
- TestFlight build `1.0 (10)` makes JARVIS the first surface: voice-first command capture,
...
- The generated Xcode project lives in `~/research/jarvis/apple_native/JARVISCompanionApps.xcodeproj`.
  ...
  and realtime JARVIS replies. App Store Connect build `1.0 (10)` is signed, uploaded,
