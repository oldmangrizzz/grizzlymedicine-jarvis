...
TEST_CASE("mel_L2_all_50_prompts", "[equivalence]") {
    ...
    // Print complete table plus worst-first ordering for failure triage.
    std::sort(results.begin(), results.end(),
              [](const PromptResult& a, const PromptResult& b) { return a.idx < b.idx; });

    std::cout << "\n=== Mel-L2 Results (all 50 prompts) ===\n";
